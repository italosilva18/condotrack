...
func (h *AuditHandler) ListAudits(c *gin.Context) {
	...
	if contractID != "" {
		...
		if err != nil {
			response.InternalError(c, "Failed to fetch audits: "+err.Error())
			return
		}
...
func (h *AuditHandler) GetAuditByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch audit: "+err.Error())
		return
	}
...
func (h *AuditHandler) GetAuditMeta(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch audit meta: "+err.Error())
		return
	}
...
func (h *AuditHandler) CreateAudit(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to create audit: "+err.Error())
		return
	}
...
func (h *AuditHandler) UpdateAudit(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update audit: "+err.Error())
		return
	}
...
func (h *AuditHandler) DeleteAudit(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete audit: "+err.Error())
		return
	}
