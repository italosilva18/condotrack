...
func (h *ContratoHandler) ListContratos(c *gin.Context) {
	...
	if gestorID != "" {
		...
		if err != nil {
			response.InternalError(c, "Failed to fetch contratos: "+err.Error())
			return
		}
...
func (h *ContratoHandler) GetContratoByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch contrato: "+err.Error())
		return
	}
...
func (h *ContratoHandler) CreateContrato(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to create contrato: "+err.Error())
		return
	}
...
func (h *ContratoHandler) UpdateContrato(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update contrato: "+err.Error())
		return
	}
...
func (h *ContratoHandler) DeleteContrato(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete contrato: "+err.Error())
		return
	}
