...
func (h *SupplierHandler) ListSuppliers(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch suppliers: "+err.Error())
		return
	}
...
func (h *SupplierHandler) GetSupplierByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch supplier: "+err.Error())
		return
	}
...
func (h *SupplierHandler) CreateSupplier(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to create supplier: "+err.Error())
		return
	}
...
func (h *SupplierHandler) UpdateSupplier(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update supplier: "+err.Error())
		return
	}
...
func (h *SupplierHandler) DeleteSupplier(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete supplier: "+err.Error())
		return
	}
