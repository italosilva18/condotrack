...
func (h *CourseHandler) ListCourses(c *gin.Context) {
	...
	if instructorID != "" {
		...
		if err != nil {
			response.InternalError(c, "Failed to fetch courses: "+err.Error())
			return
		}
...
func (h *CourseHandler) GetCourseByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch course: "+err.Error())
		return
	}
...
func (h *CourseHandler) CreateCourse(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to create course: "+err.Error())
		return
	}
...
func (h *CourseHandler) UpdateCourse(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to update course: "+err.Error())
		return
	}
...
func (h *CourseHandler) DeleteCourse(c *gin.Context) {
	...
	if err := h.usecase.DeleteCourse(ctx, id); err != nil {
		response.InternalError(c, "Failed to delete course: "+err.Error())
		return
	}
