...
func (h *RevenueHandler) ListRevenueSplits(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch revenue splits: "+err.Error())
		return
	}
...
func (h *RevenueHandler) GetRevenueSplitByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch revenue split: "+err.Error())
		return
	}
...
func (h *RevenueHandler) GetInstructorEarnings(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch instructor earnings: "+err.Error())
		return
	}
...
func (h *RevenueHandler) GetInstructorTotalEarnings(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch instructor total earnings: "+err.Error())
		return
	}
