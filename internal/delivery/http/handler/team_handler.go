...
func (h *TeamHandler) ListTeamMembers(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch team members: "+err.Error())
		return
	}
...
func (h *TeamHandler) GetTeamMemberByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch team member: "+err.Error())
		return
	}
...
func (h *TeamHandler) CreateTeamMember(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to create team member: "+err.Error())
		return
	}
...
func (h *TeamHandler) UpdateTeamMember(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update team member: "+err.Error())
		return
	}
...
func (h *TeamHandler) DeleteTeamMember(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete team member: "+err.Error())
		return
	}
...
func (h *TeamHandler) GetTeamByContract(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to fetch team for contract: "+err.Error())
		return
	}
...
func (h *TeamHandler) GetContractsByUser(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to fetch contracts for user: "+err.Error())
		return
	}
