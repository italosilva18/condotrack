...
func (h *InspectionHandler) ListInspections(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch inspections: "+err.Error())
		return
	}
...
func (h *InspectionHandler) GetInspectionByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch inspection: "+err.Error())
		return
	}
...
func (h *InspectionHandler) UpdateInspection(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update inspection: "+err.Error())
		return
	}
...
func (h *InspectionHandler) DeleteInspection(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete inspection: "+err.Error())
		return
	}
...
func (h *InspectionHandler) GetScheduledInspections(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch scheduled inspections: "+err.Error())
		return
	}
