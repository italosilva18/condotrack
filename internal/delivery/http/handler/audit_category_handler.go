...
func (h *AuditCategoryHandler) ListCategories(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch audit categories: "+err.Error())
		return
	}
...
func (h *AuditCategoryHandler) GetCategoryByID(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch audit category: "+err.Error())
		return
	}
...
func (h *AuditCategoryHandler) CreateCategory(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to create audit category: "+err.Error())
		return
	}
...
func (h *AuditCategoryHandler) UpdateCategory(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to update audit category: "+err.Error())
		return
	}
...
func (h *AuditCategoryHandler) DeleteCategory(c *gin.Context) {
	...
	if err != nil {
		...
		response.InternalError(c, "Failed to delete audit category: "+err.Error())
		return
	}
