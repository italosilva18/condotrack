...
func (h *StatsHandler) GetOverview(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch system overview: "+err.Error())
		return
	}
...
func (h *StatsHandler) GetEnrollmentStats(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch enrollment statistics: "+err.Error())
		return
	}
...
func (h *StatsHandler) GetPaymentStats(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch payment statistics: "+err.Error())
		return
	}
...
func (h *StatsHandler) GetAuditStats(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to fetch audit statistics: "+err.Error())
		return
	}
