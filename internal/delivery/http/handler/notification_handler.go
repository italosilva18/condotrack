...
// Query parameters: user_id (required), is_read (optional: "true" or "false")
func (h *NotificationHandler) ListNotifications(c *gin.Context) {
	...
	if isReadParam != "" {
		...
		if !isRead {
			...
			if err != nil {
				response.InternalError(c, "Failed to fetch notifications: "+err.Error())
				return
			}
...
func (h *NotificationHandler) GetUnreadNotifications(c *gin.Context) {
	...
	notifications, err := h.repo.FindUnreadByUserID(ctx, userID)
	if err != nil {
		response.InternalError(c, "Failed to fetch unread notifications: "+err.Error())
		return
	}
...
func (h *NotificationHandler) GetUnreadCount(c *gin.Context) {
	...
	if err != nil {
		response.InternalError(c, "Failed to count unread notifications: "+err.Error())
		return
	}
...
func (h *NotificationHandler) CreateNotification(c *gin.Context) {
	...
	if err := h.repo.Create(ctx, notification); err != nil {
		response.InternalError(c, "Failed to create notification: "+err.Error())
		return
	}
...
func (h *NotificationHandler) MarkAsRead(c *gin.Context) {
	...
	if err := h.repo.MarkAsRead(ctx, id); err != nil {
		response.InternalError(c, "Failed to mark notification as read: "+err.Error())
		return
	}
...
func (h *NotificationHandler) MarkAllAsRead(c *gin.Context) {
	...
	if err := h.repo.MarkAllAsRead(ctx, userID); err != nil {
		response.InternalError(c, "Failed to mark all notifications as read: "+err.Error())
		return
	}
...
func (h *NotificationHandler) DeleteNotification(c *gin.Context) {
	...
	if err := h.repo.Delete(ctx, id); err != nil {
		response.InternalError(c, "Failed to delete notification: "+err.Error())
		return
	}
